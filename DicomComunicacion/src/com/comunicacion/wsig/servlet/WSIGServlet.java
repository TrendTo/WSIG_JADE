...
package com.comunicacion.wsig.servlet;
...
import com.comunicacion.wsig.agent.WSIGBehaviour;
import com.comunicacion.wsig.soap.JadeToSoap;
import com.comunicacion.wsig.soap.SoapToJade;
import com.comunicacion.wsig.store.WSIGService;
import com.comunicacion.wsig.store.WSIGStore;
...
public class WSIGServlet extends HttpServlet {
	...
	private void startupWSIGAgent() {
		try {
			...
			log.warn("Jade platform not present...WSIG agent not started" + e.toString());
		}
		setWSIGStatus();
	}
